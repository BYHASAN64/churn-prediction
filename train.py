...
""" 
"""
logr = LogisticRegression(max_iter=10000)# increasing iterations do not fix misconvergance as feature scales are very different
scores = cross_val_score(LogisticRegression(max_iter=5000), X_train_scaled, y_train, cv=3, scoring="accuracy")
...
"""
"""
You need to learn probability and logistic regression during this project """
